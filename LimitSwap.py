...
def make_the_buy(inToken, outToken, buynumber, pwd, amount, gas, gaslimit, gaspriority, routing, custom, slippage, DECIMALS):
    ...
    try:
        ...
        printt("Transaction Hash = ", Web3.toHex(client.keccak(signed_txn.rawTransaction)))
    ...
    try:
        ...
        for token in tokens:
            ...
            if token['_TOKEN_BALANCE'] > 0 :
                printt_info("Your wallet already owns", token['_TOKEN_BALANCE'], token['SYMBOL'])
                ...
                if token['ENABLED'] == 'true':
                    ...
                    if quote != 0 and quote < Decimal(token['BUYPRICEINBASE']) and token['_REACHED_MAX_TOKENS'] == False:
                        ...
                        if command_line_args.sim_buy:
                            ...
                            printt_debug("tx result 3122 : ", tx)
